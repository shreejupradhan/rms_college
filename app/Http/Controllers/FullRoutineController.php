...
use App\Services\GenerateRoutine;

class FullRoutineController extends MasterController
{
    protected $routineService;

    public function __construct(GenerateRoutine $routineService)
    {
    ...
    {
        $slots =  $this->routineService->routineGenerate();

        
        $day_wise_slots = DayWiseSlot::with('day','time_slot')->get();
        
        $sections = $this->routineService->students();

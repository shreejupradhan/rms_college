...
//            $routine_committee->expire_after = $request->expire_after;
            $routine_committee->expired_date = Carbon::now('Asia/Kathmandu')->addDays($request->expired_date)->format('Y-m-d H:i:s');
            ...
            $data = [
                ...
                'email' => $user->email,
                'password' => 'password',
                'expired_date' => Carbon::now('Asia/Kathmandu')->addDays($request->expired_date)->format('Y-m-d H:i:s')
            ];
